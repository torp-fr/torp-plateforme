...
export const WIZARD_STEPS_B2G = [
  {
    ...
    name: 'Collectivité',
    shortName: 'Entité',
    description: 'Vérification des informations de votre collectivité',
    icon: 'building-2',
    estimatedMinutes: 2,
  },
  {
    ...
    name: 'Type de projet',
    shortName: 'Projet',
    description: 'Domaines d\'intervention et caractéristiques',
    icon: 'layers',
    estimatedMinutes: 4,
  },
  {
    ...
    name: 'Opération',
    shortName: 'Opération',
    description: 'Programme fonctionnel et contraintes',
    icon: 'file-text',
    estimatedMinutes: 5,
  },
  {
    ...
    name: 'Marché',
    shortName: 'Marché',
    description: 'Procédure et allotissement',
    icon: 'scale',
    estimatedMinutes: 3,
  },
  {
    ...
    shortName: 'Budget',
    description: 'Enveloppe et calendrier',
    icon: 'euro',
    estimatedMinutes: 3,
  },
  {
    ...
    name: 'Validation',
    shortName: 'DCE',
    description: 'Récapitulatif et génération DCE',
    icon: 'check-circle',
    estimatedMinutes: 2,
  },
];
